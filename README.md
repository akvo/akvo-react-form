...
| **partialRequired** | Set a custom required rule for type cascade. Set `true` to allow not filling all cascade levels when the required param is `true`                                  | Boolean \| `undefined`                                                                                           |
| **translations**    | List of translations                                                                                                                                               | Array[[Translations](<#translations-(optional)>)] \| `undefined`                                                 |
